...
export interface ButtonSliceDefaultItem {
  /**
   * Button Text field in *Button → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: button.items[].button_text
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  button_text: prismic.KeyTextField;

  /**
   * Button Link field in *Button → Items*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: button.items[].button_link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  button_link: prismic.LinkField;
}
...
export type ButtonSliceDefault = prismic.SharedSliceVariation<
  "default",
  Record<string, never>,
  Simplify<ButtonSliceDefaultItem>
>;
...
export interface ContentIndexSliceDefaultPrimary {
  ...
  /**
   * Live Link field in *ContentIndex → Primary*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index.primary.live_link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
export interface ContentIndexSliceDefaultItem {
  /**
   * Blog Link field in *ContentIndex → Items*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: content_index.items[].blog_link
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
